...
func (o *GetEventTypeEndpointsURL) WithBasePath(bp string) *GetEventTypeEndpointsURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetEventTypeEndpointsURL) Build() (*url.URL, error) {
	...
	var _path = "/v1/models/{model_id}/events/{event_type}"

	eventType := o.EventType
	if eventType != "" {
		_path = strings.Replace(_path, "{event_type}", eventType, -1)
	} else {
		return nil, errors.New("EventType is required on GetEventTypeEndpointsURL")
	}
	modelID := o.ModelID
	if modelID != "" {
		_path = strings.Replace(_path, "{model_id}", modelID, -1)
	} else {
		return nil, errors.New("ModelID is required on GetEventTypeEndpointsURL")
	}
...
func (o *GetEventTypeEndpointsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetEventTypeEndpointsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetEventTypeEndpointsURL")
	}
