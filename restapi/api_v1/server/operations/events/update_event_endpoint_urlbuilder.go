...
func (o *UpdateEventEndpointURL) WithBasePath(bp string) *UpdateEventEndpointURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *UpdateEventEndpointURL) Build() (*url.URL, error) {
	...
	if eventType != "" {
		...
		return nil, errors.New("EventType is required on UpdateEventEndpointURL")
	}
	modelID := o.ModelID
	if modelID != "" {
		_path = strings.Replace(_path, "{model_id}", modelID, -1)
	} else {
		return nil, errors.New("ModelID is required on UpdateEventEndpointURL")
	}
...
func (o *UpdateEventEndpointURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on UpdateEventEndpointURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on UpdateEventEndpointURL")
	}
